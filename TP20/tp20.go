...
func main() {
	list1 := []int{31, 41, 59, 26, 53, 58, 97, 93, 23, 84}
	list2 := []int{31, 41, 59, 26, 53, 58, 97, 93, 23, 84}
	list3 := []int{31, 41, 59, 26, 53, 58, 97, 93, 23, 84}
	fmt.Println("unsorted:", list1)

	bubblesort(list1)
	fmt.Println("sorted with bubblesort!  ", list1)

	selectionSort(list2)
	fmt.Println("sorted with selectsort!  ", list2)

	quicksort(list3)
	fmt.Println("sorted with quicksort!  ", list3)
}
